 ...
 *
 * <p>The legacy build additionally supported Quilt via quilt-loader internals; the modern modloader
 * intentionally targets Fabric only until Quilt ships a compatible 26.x loader.
 */
