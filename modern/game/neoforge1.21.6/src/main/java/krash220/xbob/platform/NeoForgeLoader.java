...
public class NeoForgeLoader {
    ...
    public NeoForgeLoader(IEventBus modBus, ModContainer container) {
        Supplier<IConfigScreenFactory> configFactory = () -> new IConfigScreenFactory() {
            @Override
            public net.minecraft.client.gui.screens.Screen createScreen(ModContainer modContainer, net.minecraft.client.gui.screens.Screen modListScreen) {
                return new Config.ConfigScreen(modContainer, modListScreen);
            }
        };
