...
public class Player {
    ...
    public static float getItemShake(float partialTicks) {
        ...
        if (camera.entity() == player && player.isUsingItem()) {
            ...
            if (anim == ItemUseAnimation.CROSSBOW && !CrossbowItem.isCharged(item) && player.getUseItemRemainingTicks() > 0) {
    ...
    public static float changeItemProgress(float partialTicks) {
        ...
        if (camera.entity() == player && !player.isPassenger() && !player.isUsingItem() && !player.swinging) {
