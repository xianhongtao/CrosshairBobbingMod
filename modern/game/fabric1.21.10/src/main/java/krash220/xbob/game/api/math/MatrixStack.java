 ...
 * <ul>
 *     <li>{@code net.minecraft.client.util.math.MatrixStack} (3D, 4x4, yarn) - world/camera math in {@code MainMod}</li>
 *     <li>{@link Matrix3x2fStack} (2D GUI) - crosshair transform in {@code InGameHud.renderCrosshair}</li>
 * </ul>
 */
