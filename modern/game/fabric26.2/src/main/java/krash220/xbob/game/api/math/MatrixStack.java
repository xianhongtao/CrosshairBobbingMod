...
/**
 * Minecraft 26.x matrix abstraction.
 *
 * <p>Supports two backing stores:
 * <ul>
 *     <li>{@link PoseStack} (3D, 4x4) - used for the world/camera math in {@code MainMod}</li>
 *     <li>{@link Matrix3x2fStack} (2D GUI) - used for the crosshair transform in {@code Hud.extractCrosshair}</li>
 * </ul>
 */
