...
public class Render {
    ...
    public static void updateCameraMatrix(MatrixStack mat, float partialTicks) {
        ...
        mat.pose().multiplyPositionMatrix(mc.gameRenderer.getBasicProjectionMatrix((float) ((GameRendererAccessor) mc.gameRenderer).callGetFov(mc.gameRenderer.getCamera(), partialTicks, true)));
    }
